 ...
 * @see Rest_Request
 */
require_once ROOT_PATH . '/Library/Rest/Request.php';
/**
 * Rest_Utils Hỗ trợ giao tiếp giữa Service và Client
 *
 */
class Rest_Utils
{
            ...
            $body = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
						<html>
							<head>
								...
								<title>' . $status . ' ' . Rest_Utils::getStatusCodeMessage($status) . '</title>
							</head>
							<body>
								<h1>' . Rest_Utils::getStatusCodeMessage($status) . '</h1>
								<p>' . $message . '</p>
								<hr />
