...
class Zend_Search_Lucene_Search_Query_Boolean extends Zend_Search_Lucene_Search_Query
{
    ...
    {
        ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Search/Weight/Boolean.php';
    ...
    public function execute(Zend_Search_Lucene_Interface $reader, $docsFilter = null)
    {
        ...
        if ($docsFilter === null) {
            ...
            ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Index/DocsFilter.php';
