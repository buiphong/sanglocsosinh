...
class Zend_Search_Lucene_Search_Query_Preprocessing_Fuzzy extends Zend_Search_Lucene_Search_Query_Preprocessing
{
    ...
    {
        if ($this->_field === null) {
            ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Search/Query/Boolean.php';
            ...
            ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Search/Query/Preprocessing/Fuzzy.php';
        ...
        if ($index->hasTerm($term)) {
            ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Search/Query/Fuzzy.php';
