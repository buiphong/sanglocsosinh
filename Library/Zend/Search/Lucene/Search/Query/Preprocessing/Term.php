...
ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Search/Query/Preprocessing.php';
...
class Zend_Search_Lucene_Search_Query_Preprocessing_Term extends Zend_Search_Lucene_Search_Query_Preprocessing
{
    ...
    {
        if ($this->_field === null) {
            ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Search/Query/MultiTerm.php';
            $query = new Zend_Search_Lucene_Search_Query_MultiTerm();
            $query->setBoost($this->getBoost());

            $hasInsignificantSubqueries = false;

            ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene.php';
            ...
            ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Search/Query/Preprocessing/Term.php';
            ...
            if (count($query->getTerms()) == 0) {
                ...
                if ($hasInsignificantSubqueries) {
                    ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Search/Query/Insignificant.php';
                    return new Zend_Search_Lucene_Search_Query_Insignificant();
                } else {
                    ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Search/Query/Empty.php';
        ...
        ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Index/Term.php';
        $term = new Zend_Search_Lucene_Index_Term($this->_word, $this->_field);
        if ($index->hasTerm($term)) {
            ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Search/Query/Term.php';
        ...
        if (count($subPatterns) > 1) {
            ...
            ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Analysis/Analyzer.php';
            foreach ($subPatterns as $id => $subPattern) {
                ...
                if (count($tokens) > 1) {
                    ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Search/QueryParserException.php';
            ...
            ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Search/Query/Wildcard.php';
