...
require_once ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Document/OpenXml.php';
...
class Zend_Search_Lucene_Document_Docx extends Zend_Search_Lucene_Document_OpenXml {
    ...
    public static function loadDocxFile($fileName, $storeContent = false) {
        if (!is_readable($fileName)) {
            ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Document/Exception.php';
