...
ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/LockManager.php';
...
class Zend_Search_Lucene_Index_Writer
{
    ...
    public function addDocument(Zend_Search_Lucene_Document $document)
    {
        ...
        ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Index/SegmentWriter/DocumentWriter.php';
    ...
    private function _mergeSegments($segments)
    {
        ...
        ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Index/SegmentMerger.php';
            ...
            for ($count = 0; $count < $segmentsCount; $count++) {
                ...
                if (!in_array($segName, $this->_segmentsToDelete)) {
                    ...
                    if (!isset($this->_segmentInfos[$segName])) {
                        ...
                        ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Index/SegmentInfo.php';
