...
class Zend_Search_Lucene_Index_SegmentMerger
{
    ...
    public function __construct($directory, $name)
    {
        ...
        ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Index/SegmentWriter/StreamWriter.php';
    ...
    private function _mergeTerms()
    {
        ...
        ROOT_PATH . DIRECTORY_SEPARATOR .'Library/Zend/Search/Lucene/Index/TermsPriorityQueue.php';
